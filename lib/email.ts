...
const FROM = process.env.EMAIL_FROM || 'TicketPing - Gmail-integrated Internal Team Pings <noreply@example.com>';
const APP_NAME = 'TicketPing - Gmail-integrated Internal Team Pings';
