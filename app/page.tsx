  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">TicketPing - Gmail-integrated Internal Team Pings</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Enables support teams and internal collaborators to quickly ping teammates directly within Gmail tickets, streamlining communication, reducing context switching, and replacing expensive internal messaging systems.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust TicketPing - Gmail-integrated Internal Team Pings.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} TicketPing - Gmail-integrated Internal Team Pings. All rights reserved.</p>
