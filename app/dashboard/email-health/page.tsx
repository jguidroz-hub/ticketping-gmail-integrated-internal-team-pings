...
export default function FeaturePage() {
  const items = [
    { t: "Domain Reputation: 92/100", d: "SPF: Pass ✅ • DKIM: Pass ✅ • DMARC: Enforced ✅", s: "healthy" },
    { t: "Deliverability Rate: 97.2%", d: "Inbox: 94% • Spam: 3% • Bounced: 0.8%", s: "good" },
    { t: "Blacklist Check: Clean", d: "Checked 120 blacklists • 0 listings • Last scan: 1h ago", s: "clear" },
    { t: "DMARC Reports: 3 failures", d: "Source: 185.234.xx.xx • Likely spoofing attempt • Action: Monitor", s: "warning" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b px-6 py-3 flex items-center gap-4">
        ...
        <h1 className="font-bold">Email Health Score</h1>
      </header>
      <div className="max-w-4xl mx-auto px-6 py-8">
        <p className="text-gray-500 text-sm mb-6">Monitor deliverability and domain reputation</p>
